...
@section('content')
    <div class="bg-white col-12 p-3 pb-5 border-start border-4 border-info">
                ...
                <div class="card bg-danger">
                    ...
                    <div class="card-footer cf-hover position-relative p-0" role="button">
                        <a href="portfolio_list.php"
                            class="d-flex justify-content-center position-relative text-white align-items-center w-100 h-100 p-2">
                            <span class="BYekan">
                                اطلاعات بیشتر
                            </span>
                            <i class="icon-left"></i>
