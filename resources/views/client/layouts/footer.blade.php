            ...
            <div class="footer-container container">
                ...
                <div class="t-footer-box col-12 my-4 d-flex align-items-start">
                    ...
                    @foreach ($menus as $menu)
                        @if($menu->position['original'] == 'Bottom')
                        <div class="col-3 footer-nav">
                            <h6 class="fs-18">{{$menu->title}}</h6>
                    ...
                    <div class="col-3 d-flex flex-column gap-4">
                        ...
                        <div class="t-footer-newsLetters">
                            <form action="">
                                <label for="newsLettersInput">ثبت‌ نام در خبرنامه جامه شاپ</label>
                ...
                <div class="c-footer-box col-12 my-4 d-flex flex-column justify-content-start">
                    <div class="c-footer-app d-flex w-100 justify-content-between align-items-center border-1 border-bottom border-silver pb-3 mb-3">
                        <span>دانلود اپلیکیشن جامه شاپ</span>
                    ...
                    <div class="c-footer-b col-12 d-flex align-items-start">
                        <div class="col-more-d c-footer-d col-7 overflow-hidden position-relative">
                            <h6>فروشگاه اینترنتی مد و لباس جامه شاپ</h6>
                            <p class="text-justify">
                                جامه شاپ، پس از تجربه‌ی موفق فروشگاه اینترنتی دیجی‌کالا به صورت تخصصی پا به عرصه مد، پوشاک و سبک زندگی گذاشت تا همان تجربه‌ی شیرین، در قالبی نو تکرار شود. در دیجی ‌استایل می‌توانید همه آنچه مرتبط با مد و پوشاک از انواع لباس زنانه، لباس مردانه و لباس
                ...
                <div class="d-footer-box border-1 border-top border-silver text-muted py-1 d-flex justify-content-between align-items-center">
                    <span> کليه حقوق اين سايت متعلق به شرکت نوآوران فن آوازه (فروشگاه اینترنتی جامه شاپ) می‌باشد. </span>
                    <span class="fs-14 d-flex align-items-center">
                        <span><i class="icon-copyright"></i>Copyright</span> - <a href="jameshop.ir" class="text-muted">jameshop.ir</a> - 2024
                    </span>
                </div>
